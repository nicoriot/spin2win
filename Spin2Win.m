...
function Spin2Win_OpeningFcn(hObject, eventdata, handles, varargin)
    ...
    % Structure data container
    handles.Shells(1).r.i = 1;
    handles.Shells(1).r.o = 1;
    handles.Shells(1).E.c = 1;
    handles.Shells(1).E.r = 1;
    handles.Shells(1).v.cr = 1;
    handles.Shells(1).rho = 1;
    handles.Shells(1).friction = 1;
    handles.Shells(1).G.rz = 1;
    handles.Shells(1).C = 1;
    handles.nShells = 1;
    handles.General.height = 1;
    handles.General.rot_speed.max = 1;
    handles.General.rot_speed.min = 1;
    handles.General.stepsize = 1;
