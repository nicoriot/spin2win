...
%% Helpers
function handles = sync_uitables(handles,task)
    switch(task)
        case 'write'
            for i = 1:handles.Data.nShells
                uitable_1(1,i)  = handles.Data.Shells(i).d.i;
                uitable_1(2,i)  = handles.Data.Shells(i).d.o;
                uitable_1(3,i)  = handles.Data.Shells(i).E.c;
                uitable_1(4,i)  = handles.Data.Shells(i).E.r;
                uitable_1(5,i)  = handles.Data.Shells(i).v;
                uitable_1(6,i)  = handles.Data.Shells(i).rho;
                uitable_1(7,i)  = handles.Data.Shells(i).mu;
                uitable_1(8,i)  = handles.Data.Shells(i).G.rz;
                uitable_1(9,i)  = handles.Data.Shells(i).Cost;
            end
            uitable_2 = [handles.Data.nShells;...
                        handles.Data.height;...
                        handles.Data.rot_speed.max;...
                        handles.Data.rot_speed.min;...
                        handles.Data.figurenr];
            set(handles.uitable1 , 'data' , uitable_1);
            set(handles.uitable1 , 'data' , uitable_1);
        case 'read'
...
function pushbutton1_Callback(hObject, eventdata, handles)
    ...
    [mout] = Main_calc(handles.Data,senddat,prefix);
    ...
    Plotter(mout.Ten_c, mout.Ten_r, mout.intf, mout.r_mark, mout.r_mark2, ...
        mout.r, mout.ri, handles.Data.figurenr, mout.stamp, prefix)
    end

% Increase plot nr if that checkbox is set
handles.Data.figurenr = handles.Data.figurenr + get(handles.checkbox2 , 'Value');
...
function pushbutton2_Callback(hObject, eventdata, handles)
    ...
    % Load default isometric data and store in handles
    handles.Data = load_default_iso;

    % Copy imported and formatted data to tables
    sync_uitables(handles,'write');
